...
Backs the `/api/trades` lookup endpoint. The Kafka topic is the source of
truth; this table is an operational, queryable mirror of the most recent
trades. A separate warehouse consumer writes the same topic to Postgres for
