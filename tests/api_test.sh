#!/usr/bin/env bash
# Exercises every REST API endpoint and prints a truncated response for each.
# Useful as a quick visual check, and as a script for generating screenshots
# for the deliverable.
#
# Usage:
#   bash tests/api_test.sh
#   API=http://otherhost:8000 SYMBOL=ETHUSD bash tests/api_test.sh
...
# OHLCV — last hour. Try GNU date first, fall back to BSD/macOS date.
